	...
	<div class="container">
		...
		<form id="form" class="frm" action="" method="post">
			...
			<c:if test="${boardDto.writer eq loginId }">
				<button type="button" id="modifyBtn" class="btn btn-write"><i class="fa fa-edit"></i>수정</button>
				<button type="button" id="removeBtn" class="btn btn-write"><i class="fa fa-trash"></i>삭제</button>
			</c:if>
